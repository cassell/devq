...
use Devq\Database\Connection\DatabaseConnectionInterface;
...
class Database implements DatabaseInterface
{
    ...
    {
        return $this->connection->delete($tableName,[$primaryKey]);
    }
    ...
    {
        return $this->connection->update($tableName,[$primaryKey],$data);
    }
